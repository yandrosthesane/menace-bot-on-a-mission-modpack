...
internal class TacticalMapOverlay
{
    ...
    /// <summary>
    /// Check if icons directory has content. Icons are generated by the tactical engine at startup.
    /// </summary>
    private void EnsureIcons(string modFolder)
    {
        try
        {
            ...
            Toast.Show("BOAM: No icons found — start the tactical engine to generate them", 8f);
        }
        catch (Exception ex)
        {
